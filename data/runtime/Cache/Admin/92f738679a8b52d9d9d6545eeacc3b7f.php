...
<![endif]-->
<link rel="stylesheet" href="/zbigdata/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/zbigdata/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/zbigdata/admin/themes/simplebootx/Public/assets/images/logo-18.png">
						数据分析平台
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/zbigdata/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
					...
					<select id="selectGames">
							<?php if(is_array($games)): foreach($games as $key=>$item): ?><option <?php echo ($item["selected"]); ?> data-status="<?php echo ($item["status"]); ?>" value="<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></option><?php endforeach; endif; ?>
					</select>
					<b style="color:white;">状态：</b><span id="game-status" style="color:white;"></span>
				</div>
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/zbigdata/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<div class="main-container container-fluid">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="macro-component-tab" id="task-content-inner">
					<li class="macro-component-tabitem noclose" app-id="0" app-url="<?php echo U('main/index');?>" app-name="首页">
						<span class="macro-tabs-item-text">活动概览</span>
					</li>
				</ul>
			...
			<div class="page-content" id="content">
				<iframe src="<?php echo U('Analysis/Summarize/overview');?>" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0" class="appiframe"></iframe>
			</div>
		</div>
	</div>
	...
	$(function(){
		...
		$('#selectGames').change(function(){
	    	...
	    	var value=self.val();
	    	$.ajax({
	    		url:"<?php echo U('admin/index/setGameId');?>",
	    		data:{id:value},
		...
		{
			var statusValue=$('#selectGames').attr('data-status');
			var spanObj=$('#game-status');
			spanObj.empty();
			if(statusValue == '0')
			{
				statusValue="已结束";
			...
			spanObj.html(statusValue);
		}
	});
	</script>
	<script src="/zbigdata/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>