...
<html>
	<head>
		...
		<link href="/zbigdata/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/zbigdata">ThinkCMF <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/zbigdata/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
