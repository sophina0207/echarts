...
<body>
	<div class="wrap">
		<div class="well" >
			<p><b>共有<?php echo ($count); ?>家媒体报道该活动</b></p>
		</div>
		...
		<div class="">
			<table class="table table-hover table-bordered table-list">
				...
				<tbody>
					  <?php if(empty($medias)): ?><tr><th style="text-align:center;" colspan='5'>暂无媒体报道</th></tr>
					<?php else: ?>
...
<script>
	var exportUrl="<?php echo U('analysis/medias/exportMedias');?>";
